...
<html lang="es">
    <head>
        <title> Registrar Usuario &copy;</title>
        <meta charset="UTF-8">
    ...
    <body >
        ...
        <div class="root">
            ...
            <form class="form-register" method="GET" action="registro_enviar.php">
                <br/>
                <br/>
                ...
                <div class="form-register__body">
                    ...
                    <div class="step" id="step-3">
                        ...
                        <div class="step__footer">
                            ...
                            <button type="submit" class="step__button step__button--back">Enviar</button>                        
                        </div>
                    </div>
                </div>
            </form>
