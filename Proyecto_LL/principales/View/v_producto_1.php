        ...
        <main>
            <div class="container py-4 text-center">
                ...
                <div class="row g-4">
                    ...
                    <div class="col-auto">
                        <center><a class="mi-boton" href="./v_producto_nuevo.php" style="background-color: #2196F3" > <i class='bx bx-message-alt-add' style="width: 60px" > Nuevo</i></a></center>
                    </div>
                </div>
                ...
                <div class="row py-4">
                    <div class="col">
                        <table class="table table-sm table-bordered table-striped">
                            ...
                            <th class="sort asc">Img</th>
                            <th class="sort asc">Stock</th>
                            <th class="sort asc">Categoria</th>
                            <th class="sort asc">Id Proveedor</th>
