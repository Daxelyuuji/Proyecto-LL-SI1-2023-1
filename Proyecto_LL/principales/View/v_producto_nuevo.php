...
<html class="es">
    ...
    <body>
        ...
        <section class="home" >
            ...
            <br/>
            <center>
                <form class="form-register" method="post" action="../Model/M_producto_procesar.php">
                    ...
                    <div class="form-register__body">
                        <div class="step active" id="step-1">
                            ...
                            <div class="step__body">
                                <label for="productos"> Nombre de Producto </label><br/>
                                <br/>
                                <input type="text"  name="productos"  class="form-control" aria-label="Username" aria-describedby="basic-addon1">
                            </div>
                            <div class="step__body">   
                                <span class="input-group-text" id="basic-addon1">Imagen del Producto</span> <br/>
                                <br/>
                                <input type="file" name="img" class="form-control" />
                            </div>
                            <div class="step__body">
                                <span class="input-group-text" id="basic-addon1">Stock del Producto </span><br/>
                                <br/>
                        ...
                        <div class="step" id="step-2">
                            ...
                            <div class="step__body">
                                ...
                                <br/>
                                <input type="text"  name="idproveedor"  class="form-control" aria-label="Username" aria-describedby="basic-addon1" required>
                            </div>
                            <div class="step__body">
                                <span class="input-group-text" id="basic-addon1">Proveedor</span><br/>
                                <br/>
                                <input type="text"  name="proveedor"  class="form-control" aria-label="Username" aria-describedby="basic-addon1" required>
                            </div>
                            <div class="step__body">
                                <span class="input-group-text" id="basic-addon1">Precio S/</span>
                                <br/>
                                <input type="text"  name="precio"  class="form-control" aria-label="Username" aria-describedby="basic-addon1" required>
                            </div>
                            <div class="step__footer">
