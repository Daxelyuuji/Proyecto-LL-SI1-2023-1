    ...
    <body class="editar">
        ...
        <div class="sises">
            <center>
                ...
                <br/>
                <form action="../Model/M_producto_procesar.php" method="post">
                    <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <input type="file"  name="img" value="<?= $producto["img"] ?>" class="form-control"  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1">
                        </div>
                    </div>
                    ...
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            ...
                            <input type="number"  name="idproveedor" value="<?= $producto["idproveedor"] ?>" class="form-control"  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Proveedor</span>
                            <input type="text"  name="proveedor" value="<?= $producto["proveedor"] ?>" class="form-control"  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required>
                        </div>
                    </div>
                    <div class="col-md-4">
                        <div class="input-group mb-3">
                            <span class="input-group-text" id="basic-addon1">Precio</span>
                            <input type="number"  name="precio" value="<?= $producto["precio"] ?>" class="form-control"  placeholder="Username" aria-label="Username" aria-describedby="basic-addon1" required>
                        </div>
                    </div>
                    <br />
                    <button class="btn btn-success" type="submit">Actualizar</button>
                    <a class="btn btn-primary" href="../View/v_producto.php">Cancelar</a>
                </form>
                <br/>
        </div>
        <br/>
