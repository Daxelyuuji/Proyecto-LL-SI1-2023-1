...
<html lang="es">
    ...
    <body style="background-color: khaki">
        ...
        <div style="padding: 2px 20px">
            <center><h1>CATEGORIA VIVERES </h1></center>
            <hr>
            <div class="row">
                <?php
                $categoria = "Viveres"; // Categoría deseada
                    ...
                    while ($row = $result->fetch_assoc()) {
                        ...
                        <div class="col-md-3">
                            <div class="card">
                                <hr>
                                <br/>
                                <?php echo "<td><img src='../Imagenes/" . $row['img'] . "' width='200' height='200' class='card-img-top'></td>"; ?>
                                <div class="card-body">
