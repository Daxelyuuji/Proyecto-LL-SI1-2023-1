                        ...
                        <div class="step" id="step-3">
                            ...
                            <div class="step__footer">
                                ...
                                <div class="botones-envio">
                                    <input type="submit" class="button" id="procesar-compra" style="padding: 4px 20px; background-color: #00bb6a; color: #ffffff; border: 0px" onclick="validarC()" value="Realizar compra">
                                </div>                     
                            </div>
