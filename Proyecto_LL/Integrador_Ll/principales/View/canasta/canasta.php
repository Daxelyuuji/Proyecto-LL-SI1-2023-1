                        ...
                        <div class="step active" id="step-1">
                            ...
                            <div class="container-fluid" style="color: green" >
                                ...
                                <div style="display:flex; " class="row">
                                    <center><a class="mi-boton" href="canasta_nuevo.php"> AGREGAR</a></center>
                                </div>
                                <div class="row">
                                    <center> <table class="tablas" border="1" WIDTH="100%" style="color: black" >
                                            <br/>
                                            <thead>
                                                <tr>
                                                    <th>ID</th>
                                            ...
                                            <tbody>
                                                <?php foreach ($registros as $canasta) : ?>
                                                    <tr style="text-align: center">
                                                        ...
                                                        <td> S/ <?= $canasta ["preciot"] ?></td>
                                                        <td>
                                                            <a href="producto_eliminar.php?id=<?= $canasta["id"] ?>">
