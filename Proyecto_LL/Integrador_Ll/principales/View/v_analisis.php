    ...
    <body>
        ...
        <section class="home" style="padding: 0px 30px; background-color: khaki;">
            <div style="display: flex; justify-content: space-between; align-items: center;">
                <h2 class="step__title" style="padding: 100px; text-align: center; color: green; flex-grow: 1;">ANALISIS - REPORTES<small></small></h2>
                <a class="my-button" href="v_dashboart.php" style="margin-left: 10px;">Dashboard</a>
            </div>
            <hr/>
            <br/>
            <div style="display: flex; justify-content: center;">
                <div style="margin-right: 20px; width: 33%" >
                    ...
                    <br/>
                    <center><a class="my-button"  href="../fpdf/PruebaV.php" style="width: 210px; background-color: red">Generar Reporte (PDF)</a></center>
                    <br/>
                    <center><a class="my-button"  href="../PhpExcel/datos_carrito.xlsx">Generar Reporte (EXCEL)</a></center>
