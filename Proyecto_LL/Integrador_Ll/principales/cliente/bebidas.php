...
<html lang="es">
    <head>
        <title> Productos - Bebidas&copy;</title>
        <meta charset="UTF-8">
    ...
    <body style="background-color: khaki">
        ...
        <div class="containerr" style="padding: 2px 20px">
            <center><h1>CATEGORIA BEBIDAS </h1></center>
            <hr>
            <div class="row">
                <?php

                $categoria = "Bebidas"; // Categoría deseada
                        ...
                        <br/>
                                ...
                                <div class="card-body">
                                    ...
                                    <div style="text-align: center">
                                        ...
                                        <input type="number" style="padding: 3px 5px; width: 80px"></div>
                                        <br/>
                                    <center><button type="submit" class="btn btn-primary btn-comprar">Añadir al carrito</button></center>
                                </div>
                            </div>
                        </div>
                        <?php
